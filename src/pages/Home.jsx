...
import HeroImage from '/images/home/geological1.avif'
import AboutImage from '/images/home/geological.avif'
...
/* ─── HOME PAGE (YOUR ORIGINAL VERSION) ─── */
...
const Home = () => {
    return (
        <>
            ...
            {/* ══════════════════════════════════════
                1. HERO — YOUR ORIGINAL OVERLAY
            ══════════════════════════════════════ */}
            <div className="relative w-full h-[92vh] min-h-[600px]">
                <img
                    src={HeroImage}
                ...
                <div className="relative h-full flex items-center px-6 lg:px-20">
                    <div className="max-w-2xl xl:max-w-3xl space-y-6">
                        ...
                        <h1 className="text-4xl md:text-5xl xl:text-6xl font-bold text-white leading-tight drop-shadow-2xl">
                            From Discovery to{' '}
                        ...
                        <div className="flex flex-wrap gap-4 pt-2">
                            <Link
                                to="/services"
                                className="inline-flex items-center gap-2 px-7 py-3.5 bg-[#764f24] hover:bg-[#a06a32] text-white font-bold rounded-full transition-all duration-300 hover:scale-105 shadow-lg group"
                            >
                            ...
                            <Link
                                to="/services"
                                className="inline-flex items-center gap-2 px-7 py-3.5 bg-white/10 backdrop-blur-sm border border-white/30 hover:bg-white/20 text-white font-bold rounded-full transition-all duration-300 hover:scale-105 group"
                            >
            ...
            {/* ══════════════════════════════════════
                2. ABOUT STRIP
            ══════════════════════════════════════ */}
            <div className="bg-[#15202a] py-20 px-6 lg:px-20">
                <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
                    ...
                    <div className="space-y-5 order-2 lg:order-1">
                        ...
                        <div className="grid grid-cols-2 gap-3 pt-2">
                            {[
                                ...
                                <div key={s.label} className="border border-[#764f24]/30 bg-white/5 p-4 hover:bg-[#764f24]/10 hover:border-[#764f24]/60 transition-all duration-300">
                    ...
                    <div className="order-1 lg:order-2 relative">
                        <div className="relative overflow-hidden">
                            ...
                            />
                            <div className="absolute top-0 left-0 w-16 h-16 border-t-4 border-l-4 border-[#764f24]" />
                            <div className="absolute bottom-0 right-0 w-16 h-16 border-b-4 border-r-4 border-[#764f24]" />
                            <div className="absolute inset-0 bg-gradient-to-t from-[#15202a]/50 to-transparent" />
                        </div>
                        <div className="absolute -bottom-5 -left-5 bg-[#764f24] px-5 py-4 shadow-xl">
                            <div className="text-white text-2xl font-bold leading-none">GEMAD</div>
                            <div className="text-white/80 text-xs tracking-widest uppercase mt-1">Mineral Assets</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="py-20 px-6 lg:px-20 bg-gray-50">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {services.map((s, i) => (
                            <Link
                                to={s.link}
                                key={i}
                                className="group bg-white border-l-4 border-[#764f24] p-7 hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
                            >
                                <div className="space-y-3">
                                    <div className="flex items-center gap-4">
                                        <div className="w-12 h-12 bg-[#15202a] flex items-center justify-center shrink-0 group-hover:bg-[#764f24] transition-colors duration-300">
                                            <s.Icon size={24} className="text-[#c89a60] group-hover:text-white transition-colors duration-300" />
                                        </div>
                                        <h3 className="text-base lg:text-lg font-bold text-[#15202a] group-hover:text-[#764f24] transition-colors duration-200 leading-snug">
                                            {s.title}
                                        </h3>
                                    </div>
                    ...
                    <div className="mt-10 text-center">
                        <Link
                            to="/services"
                            className="inline-flex items-center gap-2 px-8 py-4 bg-[#15202a] hover:bg-[#764f24] text-white font-bold rounded-full transition-all duration-300 hover:scale-105 shadow-md group"
                        >
                            View All Services
                            <FaArrowRight size={13} className="group-hover:translate-x-1 transition-transform duration-300" />
                        </Link>
            ...
            {/* ══════════════════════════════════════
                4. COMMODITIES - YOUR ORIGINAL VERSION
            ══════════════════════════════════════ */}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-7">
                        {commodities.map((c, i) => (
                            <Link
                                to="/commodities"
                                key={i}
                                className="group bg-white border border-gray-100 hover:border-[#764f24]/40 p-8 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 relative overflow-hidden"
                            >
                                ...
                                <div className="w-16 h-16 rounded-full bg-[#15202a] flex items-center justify-center mb-6 group-hover:bg-[#764f24] transition-colors duration-300 shadow-lg">
                                    <c.Icon size={30} className="text-[#c89a60] group-hover:text-white transition-colors duration-300" />
                                </div>
                                <span className="inline-block text-[10px] font-bold tracking-[0.15em] uppercase text-[#764f24] bg-[#764f24]/8 px-3 py-1 mb-3">
                                    {c.tag}
                                </span>
                                ...
                                <div className="absolute bottom-0 right-0 w-12 h-12 border-b-2 border-r-2 border-[#764f24]/20 group-hover:border-[#764f24]/60 transition-colors duration-300" />
                            </Link>
                        ))}
                    </div>
            ...
            {/* ══════════════════════════════════════
                5. VISION & MISSION
            ══════════════════════════════════════ */}
            <div className="py-20 px-6 lg:px-20 bg-[#15202a]">
                <div className="max-w-6xl mx-auto">
                    <div className="mb-12">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        <div className="border border-[#764f24]/30 bg-white/5 p-8 hover:border-[#764f24]/60 transition-all duration-300">
                            <div className="flex items-center gap-3 mb-5">
                                <div className="w-1 h-10 bg-[#764f24]" />
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {coreValues.map((v) => (
                            <div
                                key={v.num}
                                className="bg-white border-l-4 border-[#764f24] p-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
                            >
                                <div className="flex items-center gap-3 mb-3">
                                    <div className="w-8 h-8 rounded-full bg-[#15202a] text-white text-xs font-bold flex items-center justify-center shrink-0">
                                        {v.num}
                                    </div>
                                    <h3 className="font-bold text-[#15202a] text-sm">{v.title}</h3>
                                </div>
            ...
            {/* ══════════════════════════════════════
                7. WHY CHOOSE GEMAD
            ══════════════════════════════════════ */}
            <div className="py-20 px-6 lg:px-20 bg-[#15202a] relative overflow-hidden">
                ...
                <div className="max-w-6xl mx-auto relative">
                    <div className="mb-12 lg:flex lg:items-end lg:justify-between">
                        ...
                        <Link
                            to="/about"
                            className="mt-6 lg:mt-0 inline-flex items-center gap-2 px-7 py-3.5 border border-[#764f24] text-[#c89a60] hover:bg-[#764f24] hover:text-white font-semibold rounded-full transition-all duration-300 group text-sm"
                        >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                        {whyUs.map((w, i) => (
                            <div
                                key={i}
                                className="group border border-white/10 bg-white/5 p-6 hover:bg-[#764f24]/10 hover:border-[#764f24]/40 transition-all duration-300"
                            >
                                <div className="flex items-start gap-3">
                                    <MdVerified size={18} className="text-[#764f24] mt-0.5 shrink-0 group-hover:text-[#c89a60] transition-colors duration-200" />
                                    <div>
                                        <h4 className="font-bold text-white mb-2 text-sm">{w.label}</h4>
            ...
            {/* ══════════════════════════════════════
                8. ESG STRIP
            ══════════════════════════════════════ */}
            <div className="py-14 px-6 lg:px-20 bg-[#764f24]/8 border-y border-[#764f24]/20">
                <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-8">
                    ...
                    <Link
                        ...
                        className="shrink-0 inline-flex items-center gap-2 px-8 py-4 bg-[#15202a] hover:bg-[#764f24] text-white font-bold rounded-full transition-all duration-300 hover:scale-105 shadow-md group text-sm"
                    >
                        Our ESG Approach
                        <FaArrowRight size={13} className="group-hover:translate-x-1 transition-transform duration-300" />
                    </Link>
            ...
            {/* ══════════════════════════════════════
                9. CONTACT CTA — FIXED EMAIL LINK
            ══════════════════════════════════════ */}
            <div className="relative py-28 px-6 lg:px-20 bg-[#15202a] overflow-hidden">
                ...
                <div className="relative max-w-3xl mx-auto text-center space-y-6">
                    ...
                    <div className="flex flex-wrap gap-4 justify-center pt-2">
                        <Link
                            to="/contact"
                            className="inline-flex items-center gap-2 px-8 py-4 bg-[#764f24] hover:bg-[#a06a32] text-white font-bold rounded-full transition-all duration-300 hover:scale-105 shadow-lg group"
                        >
                            Contact Us Today
                            <FaArrowRight size={13} className="group-hover:translate-x-1 transition-transform duration-300" />
                        </Link>
                        <Link
                            to="/services"
                            className="inline-flex items-center gap-2 px-8 py-4 bg-white/10 border border-white/20 hover:bg-white/20 text-white font-bold rounded-full transition-all duration-300 hover:scale-105 group"
                        >
                            View Our Services
                            <FaArrowRight size={13} className="group-hover:translate-x-1 transition-transform duration-300" />
                        </Link>
                    ...
                    {/* FIXED: Email link now opens mail client */}
                    <div className="pt-4 flex flex-wrap justify-center gap-6 text-white/45 text-sm">
                        <a 
                            href="mailto:info@gemad.co.za" 
                            className="hover:text-[#c89a60] transition-colors duration-200"
                        >
                            ✉ info@gemad.co.za
                        </a>
                        <span className="hover:text-[#c89a60] transition-colors duration-200">🌍 www.gemad.co.za</span>
                        <span className="hover:text-[#c89a60] transition-colors duration-200">📍 South Africa</span>
                    </div>
                </div>
            </div>
