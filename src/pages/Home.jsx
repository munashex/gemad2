                ...
                <div className="px-6 xl:px-16 py-16 lg:py-24">
                    <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                        ...
                        <div className="space-y-5 order-2 lg:order-1">
                            ...
                            <Link
                                to="/about"
                                className="inline-flex items-center gap-2 text-[#c89a60] font-semibold hover:gap-3 transition-all duration-200 group pt-2"
                            >
                                Learn More About Us
                ...
                <div className="px-6 xl:px-16 py-16 lg:py-24">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            <div className="border border-[#764f24]/30 bg-white/5 p-8 hover:border-[#764f24]/60 transition-all duration-300 rounded-xl">
                    ...
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            {coreValues.map((v) => (
                                <div
                                    key={v.num}
                                    className="bg-white border-l-4 border-[#764f24] p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 rounded-r-lg"
                                >
                ...
                <div className="px-6 xl:px-16 py-16 lg:py-24 relative">
                    <div className="max-w-7xl mx-auto">
                        <div className="mb-12 lg:flex lg:items-end lg:justify-between">
                            ...
                            <Link
                                to="/about"
                                className="mt-6 lg:mt-0 inline-flex items-center gap-2 px-6 py-3 border border-[#764f24] text-[#c89a60] hover:bg-[#764f24] hover:text-white font-semibold rounded-full transition-all duration-300 group"
                            >
                ...
                <div className="px-6 xl:px-16 py-12">
                    <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-8">
                        ...
                        <Link
                            ...
                            className="shrink-0 inline-flex items-center gap-2 px-8 py-4 bg-[#15202a] hover:bg-[#764f24] text-white font-semibold rounded-full transition-all duration-300 hover:scale-105 shadow-md group"
                        >
                            Our ESG Approach
                            <FaArrowRight size={13} className="group-hover:translate-x-1 transition-transform duration-300" />
                        </Link>
